...
- Make the smallest correct change for each page.
- Preserve history for high-severity corrections and supersessions using strikethrough or superseded notes.
- Make contradictions explicit — never silently replace one view with another.
- Update reciprocal links on related pages.
...
- The wiki is more accurate than before.
- Historical context is preserved where it matters.
- Contradictions are visible, not hidden.
- A future session can trace how and why a claim changed.